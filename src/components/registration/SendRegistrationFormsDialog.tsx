    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-xl w-full p-6 max-h-[92vh] overflow-y-auto">
        <div className="flex items-start justify-between mb-4">
          <div>
            <h2 className="text-xl font-semibold text-slate-900">📧 שליחת טפסי רישום</h2>
            <p className="text-sm text-slate-500 mt-1">בחר נרשמים - כל נמען מקבל מייל נפרד עם הטפסים</p>
          </div>
