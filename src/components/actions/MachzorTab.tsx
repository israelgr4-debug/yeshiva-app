      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-600 mb-4">
            השיעור נגזר מה<strong>מחזור הקבוע</strong> של כל תלמיד. פעולה זו מעלה את הבסיס בשנה
            ומסנכרנת מחדש את השיעור של <strong>כל התלמידים עם מחזור</strong> (כולל לא-פעילים) —
            כך שתלמיד שחוזר לפעיל יגיע לשיעור הנכון אוטומטית. שיעור יא ← קיבוץ.
            תלמידי <strong>שיעור 0</strong> נכנסים לשיעור א ומקבלים מחזור. (כולל אינו מושפע.)
          </p>
